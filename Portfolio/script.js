...
function initContactForm() {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        // Send to backend (if server is running) or simulate
        fetch('/contact', {
            method: 'POST',
            headers: {
        ...
        .catch(error => {
            // Fallback: simulate success if server not running
            console.log('Server not running, simulating success:', { name, email, message });
...
function initScrollAnimations() {
    ...
    const animateElements = document.querySelectorAll(
        '.section-title, .about-text, .timeline-item, .project-card, .skill-category, .education-item, .achievement-card, .contact-item'
    );
...
function initTypingEffect() {
    const titleElement = document.querySelector('.hero-title .glow-text');
